  ...
  while(true) {
    ...
    for (size_t contourIdx = 0; contourIdx < contours.size(); contourIdx++) {
      ...
      double aspectRatioTolerance = 0.5;
       if (aspectRatio < bigAspectRatio - aspectRatioTolerance || aspectRatio > bigAspectRatio + aspectRatioTolerance) {
          continue;
        }
	...
	printf("Area is %.2f\n", area);
        ...
        circle( binary, center, 2, Scalar(0), 2, 8, 0);
